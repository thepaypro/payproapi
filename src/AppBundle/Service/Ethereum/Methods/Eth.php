...
use AppBundle\Service\Ethereum\Types\Address;
use AppBundle\Service\Ethereum\Types\Block;
use AppBundle\Service\Ethereum\Types\BlockHash;
use AppBundle\Service\Ethereum\Types\BlockNumber;
use AppBundle\Service\Ethereum\Types\Transaction;
use AppBundle\Service\Ethereum\Types\TransactionHash;
use AppBundle\Service\Ethereum\Types\TransactionInfo;
use AppBundle\Service\Ethereum\Types\TransactionReceipt;
use AppBundle\Service\Ethereum\Types\Wei;
...
class Eth extends AbstractMethods
{
    ...
    public function getBalance2(Address $address): Wei
    {
        $response = $this->client->send(
            $this->client->request(1, 'eth_getBalance', [$address->toString(), 'latest'])
        );
    ...
    {
        return new Transaction($from, $to, $data, $gas, $gasPrice, $value, $nonce);
    }
