...
class Version20170523165703 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE Agreements (id INT AUTO_INCREMENT NOT NULL, contis_agreement_code VARCHAR(255) NOT NULL, currency_code VARCHAR(255) NOT NULL, new_card_charge BIGINT NOT NULL, card_reissue_charge BIGINT NOT NULL, local_atmwithdraw_charge BIGINT NOT NULL, abroad_atmwithdraw_charge BIGINT NOT NULL, max_balance BIGINT NOT NULL, card_limit BIGINT NOT NULL, monthly_account_fee BIGINT NOT NULL, daily_spend_limit BIGINT NOT NULL, monthly_spend_limit BIGINT NOT NULL, max_no_of_additional_cards BIGINT NOT NULL, atmweekly_spend_limit BIGINT NOT NULL, atmmonthly_spend_limit BIGINT NOT NULL, cash_back_daily_limit BIGINT NOT NULL, cash_back_weekly_limit BIGINT NOT NULL, cash_back_monthly_limit BIGINT NOT NULL, cash_back_yearly_limit BIGINT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE Transactions (id INT AUTO_INCREMENT NOT NULL, payer_id INT DEFAULT NULL, beneficiary_id INT DEFAULT NULL, contis_transaction_id VARCHAR(255) NOT NULL, amount BIGINT NOT NULL, subject VARCHAR(255) NOT NULL, title VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_F299C1B4C17AD9A9 (payer_id), INDEX IDX_F299C1B4ECCAAFA0 (beneficiary_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE Cards (id INT AUTO_INCREMENT NOT NULL, account_id INT DEFAULT NULL, contis_card_id VARCHAR(255) DEFAULT NULL, contis_card_activation_code VARCHAR(255) DEFAULT NULL, is_active TINYINT(1) NOT NULL, is_enabled TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_C50377F99B6B5FBA (account_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE Accounts (id INT AUTO_INCREMENT NOT NULL, agreement_id INT NOT NULL, last_synced_transaction_id INT DEFAULT NULL, country_id INT NOT NULL, forename VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, birth_date DATETIME NOT NULL, document_type VARCHAR(255) NOT NULL, document_number VARCHAR(255) NOT NULL, card_holder_id VARCHAR(255) NOT NULL, account_number VARCHAR(255) NOT NULL, sort_code VARCHAR(255) NOT NULL, street VARCHAR(255) NOT NULL, building_number VARCHAR(255) DEFAULT NULL, postcode VARCHAR(255) NOT NULL, city VARCHAR(255) NOT NULL, email VARCHAR(255) DEFAULT NULL, status VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_33BEFCFA24890B2B (agreement_id), UNIQUE INDEX UNIQ_33BEFCFAABCB3E15 (last_synced_transaction_id), INDEX IDX_33BEFCFAF92F3E70 (country_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE Accounts ADD CONSTRAINT FK_33BEFCFAABCB3E15 FOREIGN KEY (last_synced_transaction_id) REFERENCES Transactions (id)');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE Accounts DROP FOREIGN KEY FK_33BEFCFAABCB3E15');
