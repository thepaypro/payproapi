...
class Version20170523165703 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE Cards (id INT AUTO_INCREMENT NOT NULL, account_id INT DEFAULT NULL, contis_card_id VARCHAR(255) NOT NULL, contis_card_activation_code VARCHAR(255) NOT NULL, is_active TINYINT(1) NOT NULL, is_enabled TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_C50377F99B6B5FBA (account_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
